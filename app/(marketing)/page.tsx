        ...
        <div className="flex items-center justify-center flex-col">
            ...
            <div className={cn(
                ...
                text-amber-700 rounded-full uppercase">
                    ...
                    No 1 task tracker app
                </div>
                <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
                    Task tracker helps team communications
                </h1>
            ...
            <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl\
             text-center mx-auto",
             textFont.className)}>
                collaborate, manage projects, and reach new productivity peaks. From high rises 
                to the home office, the way your team works is unique - 
                accomplish it all with Task tracker
            </div>
            <Button className="mt-6" size="lg" asChild>
                <Link href='/sign-up'>
                    Get task tracker for free
                </Link>
            </Button>
        </div>
    )
